...
<body onload="body_load()">
	...
	<div class="page-body">
		...
		<div class="page-content">
			...
			<form action="./CancelMeetingProServlet" method="post">
				<fieldset>
					<legend>撤销预定</legend>
					<%
					...
					<table class="formtable">
						...
						<tr>
							<td>会议描述：</td>
							<td><%=meetinginfoBean.getDescription()%></td>
						</tr>
						<tr>
							<td>撤销理由：</td>
							<td><textarea id="description" rows="5" name="deletereason"></textarea></td>
						</tr>
						<tr>
							<td><input type="hidden" name="meetingid"
								value="<%=meetinginfoBean.getMeetingid()%>"></td>
						</tr>
						<tr>
							<td class="command" colspan="2"><input type="submit"
								class="clickbutton" value="确认撤销" /> <input type="button"
